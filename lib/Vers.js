 ...
 *    'forward' function.
 */
Vers.prototype.addConverter = function(fromVer, toVer, forward, back) {
  this._pathCache = {};
...
Vers.prototype._findPath = function(cur, target, visited) {
  ...
  visits[cur] = true;
  var possibilities = Object.keys(this._converters[cur]);
 ...
 * @private
 */
Vers.prototype._wrapConverter = function(func) {
  return function(obj) {
