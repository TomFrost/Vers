...
Vers.prototype._findPath = function(cur, target, prevCur) {
  ...
  if (prevCur && !this._translators_visited[prevCur]) {
    this._translators_visited[prevCur] = {};
    this._translators_visited[prevCur][cur] = this._translators[prevCur][cur];
  }
  else if (prevCur && !this._translators_visited[prevCur][cur]) {
    this._translators_visited[prevCur][cur] = this._translators[prevCur][cur];
  }
