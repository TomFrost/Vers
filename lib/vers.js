 ...
 * function.
 * @param {Function} [versionGetter] A function that, when called with an object
 *    that's been provided to the {@link #to} or {@link #toLatest} methods,
 *    will return either the object's current version, or a Promise
